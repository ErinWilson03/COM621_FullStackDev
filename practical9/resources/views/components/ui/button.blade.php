...
$classes = match($variant) {
   ...
   'green'  => "py-1.5 px-4 text-sm transition-colors font-medium rounded-lg text-gray-100 bg-green-200  border border-green-800  hover:bg-green-800  hover:text-white disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-green-900  active:bg-green-900",
